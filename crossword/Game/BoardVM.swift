...
class BoardVM {
    ...
    init(scheme: CrosswordScheme) {
        ...
        let emptyInputRow: [String?] = Array(repeating: nil, count: scheme.numCols)
        var emptyInputGrid: [[String?]] = Array(repeating: emptyInputRow, count: scheme.numRows)
        ...
        self.state = CrosswordState(scheme: scheme, initBindingsGrid: emptyBindingsGrid, initInputGrid: emptyInputGrid, initTile: TileLoc(row: 0, col: 0), initWord: [])
